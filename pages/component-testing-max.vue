          ...
          <form>
            <fieldset>
              ...
              <div class="form-group">
                ...
                <small
                  id="fileHelp"
                  class="form-text text-muted">This is some placeholder block-level help text for
                  the
        ...
        <form>
          <div class="form-group">
            <fieldset disabled>
              <label
                class="control-label"
                for="disabledInput">Disabled input</label>
              <input
                id="disabledInput"
                class="form-control"
                type="text"
          ...
          <div class="form-group">
            <fieldset>
              <label
                class="control-label"
                for="readOnlyInput">Readonly input</label>
              <input
                id="readOnlyInput"
                class="form-control"
                type="text"
          ...
          <div class="form-group has-success">
            <label
              ...
              for="inputValid">Valid input</label>
            <input
              id="inputValid"
              type="text"
              value="correct value"
          ...
          <div class="form-group has-danger">
            <label
              class="form-control-label"
              for="inputDanger">Invalid input</label>
            <input
              id="inputDanger"
              type="text"
              value="wrong value"
          ...
          <div class="form-group">
            <label
              ...
              for="inputLarge">Large input</label>
            <input
              id="inputLarge"
          ...
          <div class="form-group">
            <label
              ...
              for="inputDefault">Default input</label>
            <input
              id="inputDefault"
              type="text"
              class="form-control"
          ...
          <div class="form-group">
            <label
              ...
              for="inputSmall">Small input</label>
            <input
              id="inputSmall"
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="custom-control custom-radio">
                ...
                <label
                  class="custom-control-label"
                  for="customRadio3">Disabled custom radio</label>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="custom-control custom-checkbox">
                ...
                <label
                  class="custom-control-label"
                  for="customCheck2">Disabled custom checkbox</label>
              </div>
            </div>
            <div class="form-group">
              <select
              ...
              <label
                class="custom-control-label"
                for="customSelect">Check this custom checkbox</label>
            </div>
            <div class="form-group">
              <div class="input-group mb-3">
          ...
          <div>
            <div class="alert alert-dismissible alert-warning">
              ...
              Praesent commodo cursus magna,
                <a
                  href="#"
                  class="alert-link">vel scelerisque nisl consectetur et</a>.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div>
            <div class="alert alert-dismissible alert-danger">
              ...
              <a
                href="#"
                class="alert-link">Change a few things up</a> and try submitting
                again.
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div>
            <div class="alert alert-dismissible alert-info">
              ...
              <a
                href="#"
                class="alert-link">alert needs your attention</a>, but it's
                not
                super important.
            </div>
          </div>
        ...
        <div class="col-lg-4">
          <div>
            <div class="list-group">
              ...
              <a
                href="#"
                class="list-group-item list-group-item-action">Dapibus ac facilisis in
              </a>
              <a
                href="#"
                class="list-group-item list-group-item-action disabled">Morbi leo risus
              </a>
            </div>
          </div>
        </div>
